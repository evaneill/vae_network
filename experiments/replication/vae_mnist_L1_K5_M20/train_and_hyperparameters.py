...
log_interval = 400
log_test_value = 100
K = 4 #@param {type:"slider", min:5, max:50, step:1}
learning_rate = 1e-4 # Was 5e-4, which overtrained
discrete_data = True
alpha = 1 #@param [0, 1] {type:"raw"}
cuda = torch.cuda.is_available()

data_name = 'mnist' #@param['silhouettes','omniglot','freyfaces','mnist']

model_type = 'vae' #@param['iwae','vrmax','vae']
